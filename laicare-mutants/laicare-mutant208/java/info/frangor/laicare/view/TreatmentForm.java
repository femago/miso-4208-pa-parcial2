...
import info.frangor.laicare.BuildConfig;
...
tName.setVisibility(android.view.View.INVISIBLE);
        tPeriod = (AppCompatEditText) null;
tPeriod.setVisibility(android.view.View.INVISIBLE);
        tTerm = (AppCompatEditText) null;
tTerm.setVisibility(android.view.View.INVISIBLE);
        tPlace = (AppCompatSpinner) null;
tPlace.setVisibility(android.view.View.INVISIBLE);
        tSpecies = (AppCompatSpinner) null;
tSpecies.setVisibility(android.view.View.INVISIBLE);
delete.setVisibility(android.view.nullete);         delete.setOnClickListener(new View.OnClickListener() {             @Override             public void onClick(View v) {                 deleteTreatment(v);
            }
        });
...
e.printStackTrace();
        ...
        // Cancel button
        AppCompatButton cancelnullsetVisibility(android.view.View.INVISIBLE);             @Override             public void onClick(View v) {                 getDialog().cancel();             }
        })
 try {
Thread.sleep(10000);
} catch (InterruptedException e) {
