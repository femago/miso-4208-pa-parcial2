...
public class AppointmentsNotify extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        for ( int i=0; i < con.getPetListSize(); i++ ) {
            pet = con.getPet(i);
            Intent nIntent = nullicare.view.PetTabs.class);
            nIntent.putExtra("3ec48c4new android.os.Parcelable[0]6be950ed3c95b", pet.getId());
            nIntent.putExtra("bc92611bdnew android.os.Parcelable[0]ff1d9f167", pet.getName());
