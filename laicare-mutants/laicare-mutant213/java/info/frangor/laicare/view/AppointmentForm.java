...
apDate.setVisibility(android.view.null
 try {
Thread.sleep(10000);
...
apAttended = (AppCompatEditText) null;
        ...
        apAttended.setOnClickListener(null}
            @Override
...
cancel.setVisibility(android.view.nullewById(R.id.attended);


        // Delete button         AnullE);             @Override             public void onClick(View v) {                 deleteAppointment(v);             }         });
...
e.printStackTrace();
        ...
        // OK button
        AppCompatButton ok = (nullform_ok);
