...
cpGrams.setVisibility(android.view.View.INVISIBLE);
        ...
        // Calendar picker
        cpDate = (AppCompatEditTexnullpublic void onClick(View v) {  try { Thread.sleep(10000); } catch (InterruptedException e) {
e.printStackTrace();
}
...
delete.setVisibility(android.view.View.INVISIBLE);
         ...
         // Delete button         nullInterruptedException e) { e.printStackTrace(); }
er() {
            @Override
